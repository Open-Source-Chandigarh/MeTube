...
// Update description with show more/less
...
// Format description links and line breaks
...
function displayComments(comments, videoChannelId) {
  ...
  comments.forEach(commentThread => {
    ...
    const hasHighEngagement = comment.likeCount > 100;
    ...
    if (isPinned && pinnedComments.length < 2) {
